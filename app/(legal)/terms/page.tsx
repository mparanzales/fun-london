...
export default function TermsPage() {
  return (
    <>
      ...
      <p>
        Fun London is a discovery guide to London venues and events. We help you
        find places and then link you out to the venue&apos;s own booking
        platform or a ticket provider.{" "}
      ...
      <p>
        We try to keep venue and event details accurate, but opening hours,
        prices and availability change. Always check with the venue before you
        travel. We are not liable for third-party content, ticket providers, or
        your experience at a venue.
      </p>
